...
(function() {
    ...
    function insertMobile() {
        ...
        fuelBox.style.cssText = 'display:flex !important;align-items:center !important;gap:5px !important;font-size:12px !important;';
        ...
        co2Box.style.cssText = 'display:flex !important;align-items:center !important;gap:5px !important;font-size:12px !important;';
    ...
    function insertMobileBunkerOverlays() {
        ...
        if (fuelContainer && !document.getElementById('bunker-fuel-overlay')) {
            ...
            fuelFillElement.style.cssText = 'font-weight:bold !important;font-size:12px !important;color:#4ade80 !important;';
            fuelFillElement.textContent = '...%';
        ...
        if (co2Container && !document.getElementById('bunker-co2-overlay')) {
            ...
            co2FillElement.style.cssText = 'font-weight:bold !important;font-size:12px !important;color:#4ade80 !important;';
            co2FillElement.textContent = '...%';
