...
(function() {
    ...
    function createCoopDisplay() {
        ...
        if (isMobile) {
            ...
            coopElement.style.cssText = 'display:flex;align-items:center;padding:2px 6px;border-radius:4px;font-size:12px;font-weight:bold;cursor:pointer;background:#4ade80;color:#333;';
